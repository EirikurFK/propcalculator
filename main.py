...
while True:
    ...
    if event == "Calculate Rent Profit":
        ...
        update_value(prop_rent_profit, "_property_rent_profit_")
    ...
    if event == "_loan_amount_text_":
        ...
        update_values("{:,}".format(values["_property_market_value_text_"] - values["_loan_amount_text_"]), "_down_payment_text_", "_down_payment_slider_")
